...
const DEFAULT_CATEGORY_PRODUCT_GROUP_OPTIONS: Array<{ value: CategoryProductGroup; label: string }> = [
...
const SHOPVNB_CATEGORY_SEEDS: Array<{
...
}> = [
  {
    name: 'Vợt Cầu Lông',
    slug: 'vot-cau-long',
    description: 'Danh mục vợt cầu lông tham khảo theo cấu trúc ShopVNB.',
    product_group: 'badminton',
    size_type: 'none',
    image_url: 'https://placehold.co/600x600/png?text=Vot+Cau+Long',
  },
  {
    name: 'Giày Cầu Lông',
    slug: 'giay-cau-long',
    description: 'Giày cầu lông cho tập luyện và thi đấu.',
    product_group: 'badminton',
    size_type: 'shoes',
    image_url: 'https://placehold.co/600x600/png?text=Giay+Cau+Long',
  },
  {
    name: 'Áo Cầu Lông',
    slug: 'ao-cau-long',
    description: 'Áo cầu lông phong trào và chuyên nghiệp.',
    product_group: 'badminton',
    size_type: 'apparel',
    image_url: 'https://placehold.co/600x600/png?text=Ao+Cau+Long',
  },
  {
    name: 'Quần Cầu Lông',
    slug: 'quan-cau-long',
    description: 'Quần cầu lông co giãn, thoáng khí.',
    product_group: 'badminton',
    size_type: 'apparel',
    image_url: 'https://placehold.co/600x600/png?text=Quan+Cau+Long',
  },
  {
    name: 'Vợt PickleBall',
    slug: 'vot-pickleball',
    description: 'Danh mục vợt pickleball theo thị trường hiện tại.',
    product_group: 'pickleball',
    size_type: 'none',
    image_url: 'https://placehold.co/600x600/png?text=Vot+Pickleball',
  },
  {
    name: 'Giày Pickleball',
    slug: 'giay-pickleball',
    description: 'Giày pickleball cho sân indoor và outdoor.',
    product_group: 'pickleball',
    size_type: 'shoes',
    image_url: 'https://placehold.co/600x600/png?text=Giay+Pickleball',
  },
  {
    name: 'Vợt Tennis',
    slug: 'vot-tennis',
    description: 'Danh mục vợt tennis theo nhóm thương hiệu phổ biến.',
    product_group: 'tennis',
    size_type: 'none',
    image_url: 'https://placehold.co/600x600/png?text=Vot+Tennis',
  },
  {
    name: 'Giày Tennis',
    slug: 'giay-tennis',
    description: 'Giày tennis hỗ trợ di chuyển đa hướng.',
    product_group: 'tennis',
    size_type: 'shoes',
    image_url: 'https://placehold.co/600x600/png?text=Giay+Tennis',
  },
];
const SHOPVNB_PRODUCT_SEEDS: Array<{
  name: string;
  slug: string;
...
}> = [
  {
    ...
    price: 4290000,
    stock: 20,
    image_url: 'https://placehold.co/600x600/png?text=Yonex+Astrox+88D+Pro',
    description: 'Mẫu vợt thiên công, cân bằng tốt giữa sức mạnh và kiểm soát.',
    size_type: 'none',
    size_options: '3U, 4U',
    color_options: 'Đen/Đỏ, Xanh Navy',
    branch_name: 'Quận 1, Quận 3',
    target_audience: 'Nam, Nữ',
    highlight_tags: 'Toàn Diện, Ổn Định',
  },
  {
    name: 'Giày Cầu Lông Victor A970 NitroLite',
    slug: 'giay-cau-long-victor-a970-nitrolite',
    category_slug: 'giay-cau-long',
    brand: 'Victor',
    price: 2390000,
    stock: 35,
    image_url: 'https://placehold.co/600x600/png?text=Victor+A970',
    description: 'Giày cầu lông đệm êm, bám sân tốt, phù hợp đánh phong trào nâng cao.',
    size_type: 'shoes',
    branch_name: 'Quận 2, Quận 5',
    target_audience: 'Nam, Nữ',
    highlight_tags: 'Êm Ái, Ổn Định',
  },
  {
    name: 'Áo Cầu Lông Lining Tour Dryfit',
    slug: 'ao-cau-long-lining-tour-dryfit',
    category_slug: 'ao-cau-long',
    brand: 'Lining',
    price: 490000,
    stock: 80,
    image_url: 'https://placehold.co/600x600/png?text=Ao+Lining+Tour',
    description: 'Áo thể thao thoáng khí, thấm hút mồ hôi tốt cho tập luyện hàng ngày.',
    size_type: 'apparel',
    branch_name: 'Quận 1, Quận 4, Quận 8',
    target_audience: 'Nam, Nữ',
    highlight_tags: 'Siêu Nhẹ',
  },
  {
    name: 'Quần Cầu Lông Kamito Active',
    slug: 'quan-cau-long-kamito-active',
    category_slug: 'quan-cau-long',
    brand: 'Kamito',
    price: 350000,
    stock: 75,
    image_url: 'https://placehold.co/600x600/png?text=Quan+Kamito+Active',
    description: 'Quần cầu lông co giãn 4 chiều, tối ưu vận động khi thi đấu.',
    size_type: 'apparel',
    branch_name: 'Quận 3, Quận 8',
    target_audience: 'Nam, Nữ',
    highlight_tags: 'Toàn Diện, Siêu Nhẹ',
  },
  {
    name: 'Vợt Pickleball Joola Hyperion C2',
    slug: 'vot-pickleball-joola-hyperion-c2',
    category_slug: 'vot-pickleball',
    brand: 'Joola',
    price: 3890000,
    stock: 25,
    image_url: 'https://placehold.co/600x600/png?text=Joola+Hyperion+C2',
    description: 'Vợt pickleball cao cấp cho người chơi bán chuyên và chuyên nghiệp.',
    size_type: 'none',
    size_options: '16mm, 14mm',
    color_options: 'Đen, Trắng',
    branch_name: 'Quận 1, Quận 2',
    target_audience: 'Nam, Nữ',
    highlight_tags: 'Toàn Diện',
  },
  {
    name: 'Giày Pickleball Asics Gel Resolution',
    slug: 'giay-pickleball-asics-gel-resolution',
    category_slug: 'giay-pickleball',
    brand: 'Asics',
    price: 2990000,
    stock: 30,
    image_url: 'https://placehold.co/600x600/png?text=Asics+Gel+Resolution',
    description: 'Giày pickleball ổn định cổ chân, phù hợp sân cứng.',
    size_type: 'shoes',
    branch_name: 'Quận 2, Quận 5',
    target_audience: 'Nam, Nữ',
    highlight_tags: 'Ổn Định, Êm Ái',
  },
  {
    name: 'Vợt Tennis Wilson Clash 100',
    slug: 'vot-tennis-wilson-clash-100',
    category_slug: 'vot-tennis',
    brand: 'Wilson',
    price: 4590000,
    stock: 18,
    image_url: 'https://placehold.co/600x600/png?text=Wilson+Clash+100',
    description: 'Vợt tennis cân bằng giữa kiểm soát và lực bóng cho nhiều trình độ.',
    size_type: 'none',
    size_options: 'G2, G3',
    color_options: 'Đen/Đỏ, Đen/Xanh',
    branch_name: 'Quận 1, Quận 3',
    target_audience: 'Nam, Nữ',
    highlight_tags: 'Toàn Diện',
  },
  {
    name: 'Giày Tennis Babolat Jet Mach',
    slug: 'giay-tennis-babolat-jet-mach',
    category_slug: 'giay-tennis',
    brand: 'Babolat',
    price: 2690000,
    stock: 28,
    image_url: 'https://placehold.co/600x600/png?text=Babolat+Jet+Mach',
    description: 'Giày tennis nhẹ, hỗ trợ tăng tốc và chuyển hướng nhanh.',
    size_type: 'shoes',
    branch_name: 'Quận 1, Quận 5',
    target_audience: 'Nam, Nữ',
    highlight_tags: 'Siêu Nhẹ, Ổn Định',
  },
  {
    ...
    price: 3790000,
    stock: 16,
    image_url: 'https://placehold.co/600x600/png?text=Victor+Thruster+Ryuga',
    description: 'Vợt cầu lông thiên công, thân cứng vừa, phù hợp người chơi tấn công.',
    size_type: 'none',
    size_options: '3U, 4U',
    color_options: 'Đen/Vàng, Đỏ/Đen',
    branch_name: 'Quận 1, Quận 5',
    target_audience: 'Nam, Nữ',
    highlight_tags: 'Toàn Diện, Ổn Định',
  },
  {
    ...
    slug: 'vot-cau-long-lining-axforce-90',
    category_slug: 'vot-cau-long',
    brand: 'Lining',
    price: 3390000,
    stock: 22,
    image_url: 'https://placehold.co/600x600/png?text=Lining+Axforce+90',
    description: 'Mẫu vợt cầu lông cao cấp với độ ổn định khung tốt, điểm ngọt rộng.',
    size_type: 'none',
    size_options: '3U, 4U',
    color_options: 'Xanh/Tím, Đen/Bạc',
    branch_name: 'Quận 2, Quận 3',
    target_audience: 'Nam, Nữ',
    highlight_tags: 'Ổn Định',
  },
  {
    name: 'Giày Cầu Lông Yonex Comfort Z3',
    slug: 'giay-cau-long-yonex-comfort-z3',
    category_slug: 'giay-cau-long',
    brand: 'Yonex',
    price: 3190000,
    stock: 26,
    image_url: 'https://placehold.co/600x600/png?text=Yonex+Comfort+Z3',
    description: 'Giày cầu lông cao cấp, đệm êm và ổn định cho trận đấu cường độ cao.',
    size_type: 'shoes',
    branch_name: 'Quận 1, Quận 4',
    target_audience: 'Nam, Nữ',
    highlight_tags: 'Êm Ái, Ổn Định',
  },
  {
    name: 'Áo Cầu Lông Yonex Tournament 2026',
    slug: 'ao-cau-long-yonex-tournament-2026',
    category_slug: 'ao-cau-long',
    brand: 'Yonex',
    price: 590000,
    stock: 60,
    image_url: 'https://placehold.co/600x600/png?text=Ao+Yonex+Tournament',
    description: 'Áo cầu lông phiên bản giải đấu, mát và nhẹ cho vận động liên tục.',
    size_type: 'apparel',
    branch_name: 'Quận 1, Quận 3, Quận 8',
    target_audience: 'Nam, Nữ',
    highlight_tags: 'Siêu Nhẹ',
  },
  {
    name: 'Quần Cầu Lông Victor Pro Match',
    slug: 'quan-cau-long-victor-pro-match',
    category_slug: 'quan-cau-long',
    brand: 'Victor',
    price: 420000,
    stock: 72,
    image_url: 'https://placehold.co/600x600/png?text=Quan+Victor+Pro+Match',
    description: 'Quần cầu lông form thể thao, nhanh khô và co giãn tốt.',
    size_type: 'apparel',
    branch_name: 'Quận 2, Quận 5',
    target_audience: 'Nam, Nữ',
    highlight_tags: 'Toàn Diện',
  ...
  {
    name: 'Vợt Pickleball Selkirk Vanguard',
    slug: 'vot-pickleball-selkirk-vanguard',
    category_slug: 'vot-pickleball',
    brand: 'Selkirk',
    price: 4490000,
    stock: 14,
    image_url: 'https://placehold.co/600x600/png?text=Selkirk+Vanguard',
    description: 'Vợt pickleball thiên kiểm soát, bề mặt nhám cho độ xoáy cao.',
    size_type: 'none',
    size_options: '16mm, 14mm',
  ...
  {
    name: 'Vợt Pickleball Wilson Blaze Elite',
    slug: 'vot-pickleball-wilson-blaze-elite',
    category_slug: 'vot-pickleball',
    brand: 'Wilson',
    price: 2790000,
    stock: 24,
    image_url: 'https://placehold.co/600x600/png?text=Wilson+Blaze+Elite',
    description: 'Vợt pickleball cân bằng công thủ, phù hợp người chơi phong trào.',
    size_type: 'none',
    size_options: '16mm, 14mm',
    color_options: 'Đen/Xanh, Trắng/Xám',
    branch_name: 'Quận 3, Quận 5',
    target_audience: 'Nam, Nữ',
    highlight_tags: 'Toàn Diện, Siêu Nhẹ',
  },
  {
    name: 'Giày Pickleball Joola Pro Court',
    slug: 'giay-pickleball-joola-pro-court',
    category_slug: 'giay-pickleball',
    brand: 'Joola',
    price: 2490000,
    stock: 32,
    image_url: 'https://placehold.co/600x600/png?text=Joola+Pro+Court',
    description: 'Giày pickleball bám sân tốt, tăng ổn định khi đổi hướng nhanh.',
    size_type: 'shoes',
    branch_name: 'Quận 1, Quận 4',
    target_audience: 'Nam, Nữ',
    highlight_tags: 'Ổn Định',
  },
  {
    ...
    slug: 'vot-tennis-babolat-pure-drive',
    category_slug: 'vot-tennis',
    brand: 'Babolat',
    price: 5190000,
    stock: 12,
    image_url: 'https://placehold.co/600x600/png?text=Babolat+Pure+Drive',
    description: 'Vợt tennis nổi tiếng với khả năng trợ lực và tốc độ bóng tốt.',
    size_type: 'none',
    size_options: 'G2, G3',
    color_options: 'Xanh/Đen',
    branch_name: 'Quận 1, Quận 3',
    target_audience: 'Nam, Nữ',
    highlight_tags: 'Toàn Diện',
  },
  {
    name: 'Vợt Tennis Head Speed MP',
    slug: 'vot-tennis-head-speed-mp',
    category_slug: 'vot-tennis',
    brand: 'Head',
    price: 4890000,
    stock: 15,
    image_url: 'https://placehold.co/600x600/png?text=Head+Speed+MP',
    description: 'Dòng vợt tennis cân bằng, hỗ trợ kiểm soát tốt khi vào bóng sớm.',
    size_type: 'none',
    size_options: 'G2, G3',
    color_options: 'Trắng/Đen',
    branch_name: 'Quận 2, Quận 5',
    target_audience: 'Nam, Nữ',
    highlight_tags: 'Ổn Định',
  },
  {
    name: 'Giày Tennis Asics Court FF 3',
    slug: 'giay-tennis-asics-court-ff-3',
    category_slug: 'giay-tennis',
    brand: 'Asics',
    price: 3290000,
    stock: 21,
    image_url: 'https://placehold.co/600x600/png?text=Asics+Court+FF+3',
    description: 'Giày tennis cao cấp, hỗ trợ ổn định mắt cá và bứt tốc khi di chuyển.',
    size_type: 'shoes',
    branch_name: 'Quận 1, Quận 8',
    target_audience: 'Nam, Nữ',
    highlight_tags: 'Ổn Định, Êm Ái',
  },
];
const SHOPVNB_TARGET_PRODUCTS_PER_CATEGORY = 10;

function buildShopVnbExpandedProductSeeds() {
  const groupedByCategory = SHOPVNB_PRODUCT_SEEDS.reduce((map, item) => {
    const key = String(item.category_slug || '').trim().toLowerCase();
    const list = map.get(key) || [];
    list.push(item);
    map.set(key, list);
    return map;
  }, new Map<string, typeof SHOPVNB_PRODUCT_SEEDS>());

  const expanded: typeof SHOPVNB_PRODUCT_SEEDS = [];
  const seenSlug = new Set<string>();
  for (const seedCategory of SHOPVNB_CATEGORY_SEEDS) {
    const categorySlug = String(seedCategory.slug || '').trim().toLowerCase();
    const baseList = groupedByCategory.get(categorySlug) || [];
    const fallbackBase = {
      name: seedCategory.name,
      slug: seedCategory.slug,
      category_slug: seedCategory.slug,
      brand: 'Nika Shop',
      price: seedCategory.size_type === 'shoes' ? 1590000 : seedCategory.size_type === 'apparel' ? 390000 : 2190000,
      stock: 30,
      image_url: seedCategory.image_url || `https://placehold.co/600x600/png?text=${encodeURIComponent(seedCategory.name)}`,
      description: `Sản phẩm mẫu cho danh mục ${seedCategory.name} theo dữ liệu tham chiếu ShopVNB.`,
      size_type: seedCategory.size_type,
      size_options: seedCategory.slug === 'vot-cau-long' ? '3U, 4U' : '',
      color_options: 'Đen, Trắng',
      branch_name: 'Quận 1, Quận 3',
      target_audience: 'Nam, Nữ',
      highlight_tags: 'Toàn Diện',
    };
    const sourceList = baseList.length > 0 ? baseList : [fallbackBase];

    for (let index = 0; index < SHOPVNB_TARGET_PRODUCTS_PER_CATEGORY; index += 1) {
      const template = sourceList[index % sourceList.length];
      const isOriginal = index < sourceList.length;
      const sequence = index + 1;
      const slug = isOriginal
        ? template.slug
        : `${template.slug}-sp-${String(sequence).padStart(2, '0')}`;
      const normalizedSlug = String(slug || '').trim().toLowerCase();
      if (!normalizedSlug || seenSlug.has(normalizedSlug)) continue;
      seenSlug.add(normalizedSlug);
      expanded.push({
        ...template,
        name: isOriginal ? template.name : `${template.name} - Mẫu ${sequence}`,
        slug,
        category_slug: categorySlug,
        price: isOriginal ? template.price : Math.max(99000, template.price + sequence * 30000),
        stock: isOriginal ? template.stock : template.stock + (sequence % 7) + 3,
        image_url: isOriginal
          ? template.image_url
          : `https://placehold.co/600x600/png?text=${encodeURIComponent(`${seedCategory.name} ${sequence}`)}`,
        description: isOriginal
          ? template.description
          : `${template.description} (phiên bản mở rộng ${sequence} theo danh mục tham chiếu ShopVNB).`,
      });
    }
  }
  return expanded;
}
const SHOPVNB_PRODUCT_SEEDS_EXPANDED = buildShopVnbExpandedProductSeeds();
...
function formatGroupLabelFromKey(groupKey: string) {
  const normalized = String(groupKey || '').trim();
  if (!normalized) return 'Nhóm khác';
  return normalized
    .split('-')
    .filter(Boolean)
...
function SidebarToggleGlyph({ isOpen, className = 'w-3.5 h-3.5' }: { isOpen: boolean; className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} className={className} aria-hidden="true">
      <path strokeLinecap="round" strokeLinejoin="round" d="M4 6a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2z" />
      <path strokeLinecap="round" d="M9 4v16" />
      <path strokeLinecap="round" strokeLinejoin="round" d={isOpen ? 'M15 10l-2 2l2 2' : 'M13 10l2 2l-2 2'} />
    </svg>
  );
}
...
export default function StaffDashboardPage() {
  ...
  const [categoryGroups, setCategoryGroups] = useState<CategoryGroupItem[]>([]);
  ...
  const [aboutFeatureEnabled, setAboutFeatureEnabled] = useState(true);
  ...
  const newProductFinalPriceDisplay = newProduct.price
    ? formatVndInput(String(newProductFinalPrice))
    : '';
  ...
  useEffect(() => {
    ...
    if (!STAFF_RESTRICTED_TABS.includes(activeTab)) return;
    const fallbackTab: StaffTab = 'products_list';
  ...
  }, [activeTab, isAdmin, isStaff, setSearchParams]);
  ...
  useEffect(() => {
    ...
    const loadStaffData = async () => {
      ...
      if (categoryGroupsRes.error) {
        ...
        const nextGroups = ((categoryGroupsRes.data || []) as CategoryGroupItem[])
          .filter(item => String(item.group_key || '').trim())
          .map(item => ({
            ...item,
            group_key: String(item.group_key || '').trim(),
            group_label: String(item.group_label || '').trim(),
          }));
        setCategoryGroups(nextGroups);
      }
      if (siteContentRes.error) {
        setAboutFeatureEnabled(false);
        setAboutContentId('');
        setAboutContentValue('');
      } else {
        const aboutContent = (siteContentRes.data || null) as SiteContentItem | null;
  ...
  const categoryProductGroupOptions = useMemo(() => {
    const optionMap = new Map<string, string>();
    DEFAULT_CATEGORY_PRODUCT_GROUP_OPTIONS.forEach(option => {
      optionMap.set(String(option.value), option.label);
    });
    categoryGroups.forEach(item => {
      const key = String(item.group_key || '').trim();
      const label = String(item.group_label || '').trim();
      if (!key) return;
      optionMap.set(key, label || formatGroupLabelFromKey(key));
    });
    categories.forEach(item => {
      const key = String(item.product_group || '').trim();
      if (!key || optionMap.has(key)) return;
      optionMap.set(key, formatGroupLabelFromKey(key));
    });
    return Array.from(optionMap.entries()).map(([value, label]) => ({ value, label }));
  }, [categories, categoryGroups]);
  const getCategoryGroupLabel = (groupValue?: string | null) => {
    const normalized = String(groupValue || '').trim();
    if (!normalized) return 'Sản phẩm cầu lông';
    return categoryProductGroupOptions.find(item => item.value === normalized)?.label || formatGroupLabelFromKey(normalized);
  };
  ...
  const openInventoryPopup = (product: Product) => {
    ...
    setInventoryPopupProductId(product.id);
    setInventoryPopupSelectedSize(defaultSize);
    setInventoryPopupStockValue(currentValue);
  };

  const closeInventoryPopup = () => {
    setInventoryPopupProductId(null);
    setInventoryPopupSelectedSize('');
    setInventoryPopupStockValue('');
  };

  const handleInventoryPopupSizeChange = (nextSize: string) => {
    ...
    setInventoryPopupSelectedSize(nextSize);
    setInventoryPopupStockValue(nextValue);
  };

  const handleSaveInventoryFromPopup = async () => {
    if (!inventoryPopupProductId) return;
    const nextSize = inventoryPopupSelectedSize || null;
    const draftKey = nextSize ? `${inventoryPopupProductId}::${nextSize}` : inventoryPopupProductId;
    setStockDrafts(prev => ({ ...prev, [draftKey]: inventoryPopupStockValue }));
    const success = await handleUpdateStock(inventoryPopupProductId, nextSize, inventoryPopupStockValue);
    if (success) {
      closeInventoryPopup();
    }
  };
  ...
  const closeCreateCategoryGroupPopup = () => {
    setIsCreateGroupPopupOpen(false);
    setNewCategoryGroupLabel('');
  };

  const handleCreateCategoryGroup = async () => {
    const rawLabel = newCategoryGroupLabel.trim();
    if (!rawLabel) {
      window.alert('Vui lòng nhập tên nhóm.');
      return;
    }
    const normalizedLabel = rawLabel.replace(/\s+/g, ' ');
    const existingByLabel = categoryProductGroupOptions.some(
      option => normalizeSearchKeyword(option.label) === normalizeSearchKeyword(normalizedLabel),
    );
    if (existingByLabel) {
      window.alert('Nhóm này đã tồn tại.');
      return;
    }
    const baseKey = slugify(normalizedLabel).slice(0, 30) || `group-${Date.now()}`;
    const existingKeys = new Set(categoryProductGroupOptions.map(option => String(option.value)));
    let uniqueKey = baseKey;
    let suffix = 2;
    while (existingKeys.has(uniqueKey)) {
      uniqueKey = `${baseKey.slice(0, Math.max(1, 27))}-${suffix}`;
      suffix += 1;
    }

    setCreatingCategoryGroup(true);
    const { data, error: createError } = await db
      ...
      .select('*')
      .maybeSingle();
    setCreatingCategoryGroup(false);

    if (createError || !data) {
      window.alert(createError?.message || 'Không thể tạo nhóm mới.');
      return;
    }

    const created = data as CategoryGroupItem;
    setCategoryGroups(prev => [...prev, created]);
    setNewCategoryProductGroup(created.group_key);
    closeCreateCategoryGroupPopup();
  };

  const handleSaveAboutContent = async () => {
    if (!isAdmin) {
      setAboutContentError('Chỉ admin mới có quyền chỉnh sửa giới thiệu.');
      return;
    }
    const nextContent = String(aboutContentValue || '').trim();
    if (!nextContent) {
      setAboutContentError('Nội dung giới thiệu không được để trống.');
      return;
    }

    setAboutContentError('');
    ...
    if (aboutContentId) {
      ...
      setSubmitting(false);
      if (updateError || !data) {
        setAboutContentError(updateError?.message || 'Không thể lưu nội dung giới thiệu.');
        return;
      }
      setAboutContentValue(String((data as SiteContentItem).content_value || ''));
      setAboutContentMessage('Đã lưu nội dung giới thiệu.');
      return;
    }
    ...
    setSubmitting(false);
    if (createError || !data) {
      setAboutContentError(createError?.message || 'Không thể tạo nội dung giới thiệu.');
      return;
    }
    const created = data as SiteContentItem;
    setAboutContentId(String(created.id || ''));
    setAboutContentValue(String(created.content_value || ''));
  ...
  const handleDeleteCategory = async (categoryId: string) => {
    if (!isAdmin) {
      window.alert('Chỉ admin mới có quyền xóa danh mục.');
      return;
    }
  ...
  const handleDeleteHomeCategorySection = async (sectionId: string) => {
    if (!isAdmin) {
      window.alert('Chỉ admin mới có quyền xóa section.');
      return;
    }
  ...
  const handleDeleteBanner = async (bannerId: string) => {
    if (!isAdmin) {
      window.alert('Chỉ admin mới có quyền xóa banner.');
      return;
    }
  ...
  const handleDeleteAllBanners = async () => {
    if (!isAdmin) {
      window.alert('Chỉ admin mới có quyền xóa toàn bộ banner.');
      return;
    }
  ...
  const removeGalleryImage = (target: 'new' | 'edit', imageUrl: string) => {
    if (target === 'new') {
      setNewProductGalleryUrls(prev => {
        const next = prev.filter(url => url !== imageUrl);
        setNewProduct(prevProduct => {
          if (prevProduct.image_url !== imageUrl) return prevProduct;
          return {
            ...prevProduct,
            image_url: next[0] || '',
          };
    ...
    setEditProductGalleryUrls(prev => {
      const next = prev.filter(url => url !== imageUrl);
  ...
  const handleImportShopVnbCatalog = async () => {
    if (!window.confirm('Nhập nhanh danh mục và sản phẩm mẫu từ ShopVNB?')) return;
    setShopVnbImporting(true);
    ...
    const categoryBySlug = new Map<string, Category>(
      categories.map(item => [String(item.slug || '').trim().toLowerCase(), item]),
    );
    const productsBySlug = new Set(
      products.map(item => String(item.slug || '').trim().toLowerCase()).filter(Boolean),
    );

    try {
      for (const seedCategory of SHOPVNB_CATEGORY_SEEDS) {
        const slugKey = seedCategory.slug.toLowerCase();
        if (categoryBySlug.has(slugKey)) {
          skippedCategories += 1;
          continue;
        }
        const sizeValues = getAllowedSizesByType(seedCategory.size_type).join(',');
        const { data, error: createError } = await db
          .from('categories')
          .insert({
            name: seedCategory.name,
            ...
            image_url: seedCategory.image_url,
            product_group: seedCategory.product_group,
            size_type: seedCategory.size_type,
            size_values: sizeValues || null,
          })
          .select('*')
          .maybeSingle();
        if (createError || !data) {
          window.alert(createError?.message || `Không thể tạo danh mục ${seedCategory.name}.`);
          continue;
        }
        const categoryItem = data as Category;
        createdCategories.push(categoryItem);
        categoryBySlug.set(slugKey, categoryItem);
      }

      const nextCategories = [...createdCategories, ...categories];
      if (createdCategories.length > 0) {
        setCategories(nextCategories);
      }

      const categoryIdBySlug = nextCategories.reduce((map, item) => {
        const slugKey = String(item.slug || '').trim().toLowerCase();
        const idValue = String(item.id || '').trim();
        if (slugKey && idValue) {
          map.set(slugKey, idValue);
        }
        return map;
      }, new Map<string, string>());

      for (const seedProduct of SHOPVNB_PRODUCT_SEEDS_EXPANDED) {
        const productSlugKey = seedProduct.slug.toLowerCase();
        if (productsBySlug.has(productSlugKey)) {
          skippedProducts += 1;
          continue;
        }
        const categoryId = categoryIdBySlug.get(seedProduct.category_slug.toLowerCase());
        if (!categoryId) {
          failedProducts += 1;
          continue;
        }
        const sizeOptions = seedProduct.size_options || (seedProduct.size_type === 'apparel'
          ? APPAREL_SIZES.join(', ')
          : seedProduct.size_type === 'shoes'
            ? SHOES_SIZES.join(', ')
            : '');
        const { data, error: createError } = await db
          .from('products')
          .insert({
            ...
            category_id: categoryId,
            image_url: seedProduct.image_url,
            image_gallery: JSON.stringify([seedProduct.image_url]),
            size_type: seedProduct.size_type,
            size_options: sizeOptions || null,
            color_options: (seedProduct.color_options || '').trim() || null,
            branch_name: seedProduct.branch_name || null,
            target_audience: seedProduct.target_audience || null,
            highlight_tags: seedProduct.highlight_tags || null,
            shoe_form: null,
            play_style: null,
            segment: null,
        ...
        const productItem = data as Product;
        createdProducts.push(productItem);
        productsBySlug.add(productSlugKey);
      }
      ...
      window.alert(
        `Đã nhập dữ liệu ShopVNB.\n- Danh mục mới: ${createdCategories.length}\n- Danh mục đã có sẵn: ${skippedCategories}\n- Sản phẩm mới: ${createdProducts.length}\n- Sản phẩm đã có sẵn: ${skippedProducts}\n- Sản phẩm lỗi/thiếu danh mục: ${failedProducts}`,
      );
    } finally {
      setShopVnbImporting(false);
    }
  };
  ...
  const handleDeleteProduct = async (productId: string) => {
    if (!isAdmin) {
      window.alert('Chỉ admin mới có quyền xóa sản phẩm.');
      return;
    }
    const targetProduct = products.find(item => item.id === productId);
    const productName = String(targetProduct?.name || 'sản phẩm này');
    if (!window.confirm(`Bạn có chắc muốn xóa "${productName}"?`)) return;

    setSubmitting(true);
    const { error: deleteError } = await db.from('products').delete().eq('id', productId);
    setSubmitting(false);
    if (deleteError) {
      window.alert(deleteError.message || 'Không thể xóa sản phẩm.');
      return;
    }
  ...
  const baseMenuItems: Array<{ id: StaffTab; label: string; icon: any }> = [
  ...
  const menuItems: Array<{ id: StaffTab; label: string; icon: any }> = isAdmin
    ? baseMenuItems
    : baseMenuItems.filter(item => !STAFF_RESTRICTED_TABS.includes(item.id));
  ...
  const accountMenuItems: Array<{ id: StaffTab; label: string }> = isAdmin
    ? baseAccountMenuItems
    : baseAccountMenuItems.filter(item => item.id === 'customers');
  ...
  return (
    <div className="min-h-[calc(100vh-80px)] bg-slate-100">
      <div className="flex">
        <aside
          className={`flex flex-shrink-0 min-h-[calc(100vh-80px)] flex-col py-6 border-r shadow-xl overflow-y-auto ${isSidebarOpen ? 'px-5' : 'px-2 items-center'}`}
          style={{
            ...
            maxWidth: isSidebarOpen ? '280px' : '64px',
          }}
        >
          <div className={`mb-8 ${isSidebarOpen ? 'px-2' : 'px-0'}`}>
          ...
          {isSidebarOpen && <p className="px-2 text-[11px] tracking-widest text-zinc-300 uppercase mb-2">Menu</p>}
          <div className={`space-y-1 ${isSidebarOpen ? '' : 'w-full flex flex-col items-center'}`}>
            {menuItems.filter(item => item.id === 'overview').map(item => (
              <button
                ...
                title={item.label}
                className={`w-full flex items-center ${isSidebarOpen ? 'gap-3 px-3 justify-start' : 'justify-center px-0'} py-2.5 rounded-lg text-sm transition-colors ${
                  activeTab === item.id
            ...
            >
              <span className={`inline-flex items-center ${isSidebarOpen ? 'gap-3' : ''}`}>
                ...
                {isSidebarOpen && 'Sản phẩm'}
              </span>
              {isSidebarOpen && <ChevronDown className={`w-4 h-4 transition-transform ${isProductMenuOpen ? 'rotate-180' : ''}`} />}
            </button>

            {isSidebarOpen && isProductMenuOpen && (
            ...
            <button
              ...
              title={isAdmin ? 'Tài khoản' : 'Khách hàng'}
              className={`w-full flex items-center ${isSidebarOpen ? 'justify-between px-3' : 'justify-center px-0'} py-2.5 rounded-lg text-sm transition-colors ${
            ...
            >
              <span className={`inline-flex items-center ${isSidebarOpen ? 'gap-3' : ''}`}>
                ...
                {isSidebarOpen && (isAdmin ? 'Tài khoản' : 'Khách hàng')}
              </span>
              {isSidebarOpen && isAdmin && <ChevronDown className={`w-4 h-4 transition-transform ${isAccountMenuOpen ? 'rotate-180' : ''}`} />}
            </button>
          ...
          <div className={`mt-auto pt-6 ${isSidebarOpen ? '' : 'w-full flex justify-center'}`}>
            <Link
              to="/dashboard"
              title="Về trang khách hàng"
              className={`inline-flex items-center ${isSidebarOpen ? 'gap-2 text-sm' : 'text-base justify-center w-10 h-10 rounded-lg hover:bg-zinc-800'} text-zinc-100 hover:text-white transition-colors`}
            >
              <Home className="w-4 h-4" />
              {isSidebarOpen && 'Về trang khách hàng'}
            </Link>
          </div>
        </aside>

        <main className="flex-1 min-w-0 p-4 sm:p-6 lg:p-8">
          <div className="bg-white border border-slate-200 rounded-2xl px-4 py-2.5 sm:px-6 flex flex-wrap items-center gap-3 justify-between mb-6">
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="inline-flex items-center justify-center w-8 h-8 rounded-md border border-slate-300 text-slate-700 bg-white hover:bg-slate-50 transition-colors"
                aria-label={isSidebarOpen ? 'Thu gọn thanh công cụ' : 'Mở rộng thanh công cụ'}
              >
                <SidebarToggleGlyph isOpen={isSidebarOpen} />
              </button>
            </div>
                ...
                <>
                  ...
                  <form onSubmit={handleCreateProduct} className="border border-slate-200 rounded-xl p-4 bg-slate-50/60 space-y-4">
                    ...
                    <div className="grid grid-cols-1 xl:grid-cols-3 gap-4">
                      <div className="border border-slate-200 rounded-xl bg-white p-4 space-y-3">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          ...
                          <input
                            type="text"
                            readOnly
                            value={newProductFinalPriceDisplay}
                            placeholder="Giá bán sau giảm"
                            className="h-10 w-full px-3 border border-slate-200 rounded-lg text-sm bg-slate-100 text-slate-700"
                          />
                        </div>
                        <select
                        ...
                        <div className="h-10 px-3 border border-slate-200 rounded-lg text-xs bg-white flex items-center text-slate-500">
                          {normalizeCommaValues(newProduct.branch_name).length > 0
                            ? `Chi nhánh đã chọn: ${normalizeCommaValues(newProduct.branch_name).join(', ')}`
                            : 'Chưa chọn chi nhánh'}
                        </div>
                      </div>

                      <div className="border border-slate-200 rounded-xl bg-white p-4 space-y-3">
                        <h4 className="text-sm font-semibold text-slate-900">Ảnh & mô tả</h4>
                        ...
                        <textarea rows={8} value={newProduct.description} onChange={event => setNewProduct(prev => ({ ...prev, description: event.target.value }))} placeholder="Mô tả sản phẩm" className="w-full px-3 py-2 border border-slate-200 rounded-lg text-sm bg-white resize-none" />
                      </div>

                      <div className="space-y-3">
                        <div className="border border-slate-200 rounded-xl bg-white p-4 space-y-3">
                          <h4 className="text-sm font-semibold text-slate-900">Thuộc tính</h4>
                          <select
                      ...
                      <div className="border border-slate-200 rounded-lg bg-white p-3 space-y-2 md:col-span-2">
                        <p className="text-xs font-semibold text-slate-700 uppercase">Chi nhánh</p>
                        <div className="flex flex-wrap gap-2">
                          {branches.map(branch => (
                            <label key={branch.id} className="inline-flex items-center gap-1.5 text-xs text-slate-700">
                              <input
                                type="checkbox"
                                checked={isCheckedInCsv(newProduct.branch_name, branch.name)}
                                onChange={event => setNewProduct(prev => ({ ...prev, branch_name: toggleCsvValue(prev.branch_name, branch.name, event.target.checked) }))}
                  ...
                  <div className="space-y-3">
                    {visibleProducts.map(product => (
                      <div key={product.id} className={editingProductId === product.id ? '' : 'border border-slate-100 rounded-xl p-4 space-y-3'}>
                        {editingProductId === product.id ? (
                          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                            <button
                              ...
                              aria-label="Đóng popup chỉnh sửa sản phẩm"
                            />
                            <div className="relative w-full max-w-5xl max-h-[90vh] overflow-y-auto rounded-2xl bg-white shadow-2xl border border-slate-200 p-4 sm:p-5 space-y-3">
                              ...
                              />
                              <div className="h-10 px-3 border border-slate-200 rounded-lg text-xs bg-white flex items-center text-slate-500">
                                {normalizeCommaValues(editProduct.branch_name).length > 0
                                  ? `Chi nhánh đã chọn: ${normalizeCommaValues(editProduct.branch_name).join(', ')}`
                                  : 'Chưa chọn chi nhánh'}
                              </div>
                              <input
                                type="text"
                                ...
                                <div className="flex flex-wrap gap-2">
                                  {branches.map(branch => (
                                    <label key={branch.id} className="inline-flex items-center gap-1.5 text-xs text-slate-700">
                                      <input
                                        type="checkbox"
                                        checked={isCheckedInCsv(editProduct.branch_name, branch.name)}
                                        onChange={event => setEditProduct(prev => ({ ...prev, branch_name: toggleCsvValue(prev.branch_name, branch.name, event.target.checked) }))}
                                        className="rounded border-slate-300"
                                      />
                                      {branch.name}
                                    </label>
                          ...
                          <button
                            ...
                            className="w-full text-left flex flex-wrap items-center justify-between gap-3 hover:bg-blue-50/30 rounded-lg p-1 transition-colors"
                          >
                    ...
                    {visibleInventoryProducts.map(product => {
                      ...
                      return (
                        <button
                          key={product.id}
                          type="button"
                          onClick={() => openInventoryPopup(product)}
                          className="w-full border border-slate-100 rounded-xl p-4 flex flex-wrap items-center justify-between gap-3 text-left hover:border-blue-200 hover:bg-blue-50/30 transition-colors"
                        >
                          <div className="flex items-center gap-3 min-w-0">
                            {product.image_url ? (
                              <img
                          ...
                          <div className="text-sm text-slate-500">
                            Bấm để chỉnh tồn kho
                          </div>
                        </button>
                      );
                    })}
                    {visibleInventoryProducts.length === 0 && (
                      <div className="border border-dashed border-slate-300 rounded-xl p-5 text-sm text-slate-500 bg-white">
                  ...
                  {inventoryPopupProductId && (() => {
                    ...
                    return (
                      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                        ...
                        />
                        <div className="relative w-full max-w-lg rounded-2xl bg-white shadow-2xl border border-slate-200 p-5 space-y-4">
                          <div className="flex items-start justify-between gap-3">
                            <div>
                              <h3 className="text-lg font-bold text-slate-900">Chỉnh sửa tồn kho</h3>
                              <p className="text-sm text-slate-500 mt-1">{targetProduct.name}</p>
                            </div>
                            <button
                              type="button"
                              onClick={closeInventoryPopup}
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                            <div className="space-y-1">
                              <p className="text-xs font-semibold text-slate-600 uppercase">Size</p>
                              {sizeOptions.length > 0 ? (
                                <select
                                  value={inventoryPopupSelectedSize}
                                  onChange={event => handleInventoryPopupSizeChange(event.target.value)}
                                  className="h-10 w-full px-3 border border-slate-200 rounded-lg text-sm bg-white"
                                >
                                ...
                                <div className="h-10 px-3 border border-slate-200 rounded-lg text-sm bg-slate-50 flex items-center text-slate-600">
                                  Không áp dụng
                                </div>
                              )}
                            </div>
                            <div className="space-y-1">
                              <p className="text-xs font-semibold text-slate-600 uppercase">Tồn kho hiện tại</p>
                              <div className="h-10 w-full px-3 border border-slate-200 rounded-lg text-sm bg-slate-50 flex items-center font-semibold text-slate-700">
                                {Math.max(0, Math.floor(Number.isFinite(currentStockValue) ? currentStockValue : 0))}
                              </div>
                            </div>
                            <div className="space-y-1">
                              <p className="text-xs font-semibold text-slate-600 uppercase">Số lượng tồn kho</p>
                              <input
                                type="number"
                                min={0}
                                value={inventoryPopupStockValue}
                                onChange={event => setInventoryPopupStockValue(event.target.value)}
                          ...
                          <div className="flex items-center justify-end gap-2 pt-2">
                            <button
                              type="button"
                              onClick={closeInventoryPopup}
                              className="h-10 px-4 rounded-lg text-sm font-medium text-slate-700 bg-slate-100 hover:bg-slate-200"
                            >
                              Hủy
                            </button>
                            <button
                              type="button"
                              onClick={handleSaveInventoryFromPopup}
                              disabled={submitting}
                              className="h-10 px-4 rounded-lg text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 disabled:opacity-50"
                            >
                              {submitting ? 'Đang lưu...' : 'Lưu tồn kho'}
                            </button>
                          </div>
                        </div>
                      </div>
                    ...
                    {visibleNewProducts.map(product => (
                      <div key={product.id} className="border border-slate-100 rounded-xl p-4 flex flex-wrap items-center justify-between gap-3">
                        ...
                        <div className="flex items-center gap-2">
                          <button
                            onClick={() => {
                              handleQuickEditProduct(product);
                            }}
                  ...
                  <form onSubmit={handleCreateBanner} className="border border-slate-200 rounded-xl p-4 bg-slate-50/60 space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
                      ...
                      <select
                        ...
                        className="h-10 px-3 border border-slate-200 rounded-lg text-sm bg-white"
                      >
                        <option value="none">Ảnh thủ công (không gắn link)</option>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                  <div className="flex items-center gap-2">
                    <select
                      ...
                      className="h-10 min-w-0 flex-1 px-3 border border-slate-200 rounded-lg text-sm bg-white"
                    >
                    ...
                    <button
                      ...
                      className="h-10 px-3 rounded-lg text-sm font-semibold border border-slate-300 bg-white text-slate-700 hover:bg-slate-50"
                    >
              ...
              {isCreateGroupPopupOpen && (
                <div className="fixed inset-0 z-[70] bg-slate-900/35 backdrop-blur-[1px] flex items-center justify-center p-4">
                  <div className="w-full max-w-sm rounded-xl bg-white border border-slate-200 shadow-xl p-4 space-y-3">
                    <h4 className="text-sm font-semibold text-slate-900">Thêm nhóm sản phẩm</h4>
                    <input
                      value={newCategoryGroupLabel}
                      onChange={event => setNewCategoryGroupLabel(event.target.value)}
                      placeholder="Tên nhóm (VD: Sản phẩm bóng đá)"
                      className="h-10 w-full px-3 border border-slate-200 rounded-lg text-sm bg-white"
                    />
                    <div className="flex items-center justify-end gap-2 pt-1">
                      <button
                        type="button"
                        onClick={closeCreateCategoryGroupPopup}
                        disabled={creatingCategoryGroup}
                      ...
                      <button
                        type="button"
                        onClick={handleCreateCategoryGroup}
                        disabled={creatingCategoryGroup}
                        className="h-9 px-3 rounded-lg text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 disabled:opacity-50"
                      >
                        {creatingCategoryGroup ? 'Đang lưu...' : 'Lưu'}
                      </button>
                    </div>
                  </div>
                </div>
          ...
          {activeTab === 'about_content' && (
            <div className="bg-white border border-slate-200 rounded-2xl p-5 space-y-4">
              <h2 className="text-lg font-bold text-slate-900">Quản lý nội dung Giới thiệu</h2>
              {!aboutFeatureEnabled && (
                <div className="p-4 rounded-xl bg-amber-50 border border-amber-200 text-amber-800 text-sm">
              ...
              {aboutFeatureEnabled && (
                <>
                  <p className="text-sm text-slate-600">
                    Nội dung tại đây sẽ hiển thị trên trang `Giới thiệu` ở header và chỉ hiển thị dạng văn bản.
                  </p>
                  <textarea
                    value={aboutContentValue}
                    onChange={event => setAboutContentValue(event.target.value)}
                    rows={14}
                    disabled={!isAdmin}
                  ...
                  />
                  {aboutContentError && <p className="text-sm text-rose-600">{aboutContentError}</p>}
                  {aboutContentMessage && <p className="text-sm text-emerald-700">{aboutContentMessage}</p>}
                  <div className="flex items-center justify-end gap-2">
                    <button
                      type="button"
                      onClick={() => setShowAboutPreview(prev => !prev)}
                      className="px-4 py-2 rounded-lg text-sm font-medium text-slate-700 bg-slate-100 hover:bg-slate-200"
                    >
                      {showAboutPreview ? 'Ẩn xem trước' : 'Xem trước'}
                    </button>
                    <button
                      type="button"
                  ...
                  {showAboutPreview && (
                    <div className="rounded-xl border border-slate-200 bg-slate-50 p-4">
                      <p className="text-xs font-semibold tracking-wider text-slate-500 uppercase mb-3">Xem trước trang Giới thiệu</p>
                      <h3 className="text-2xl font-extrabold text-slate-900 uppercase mb-4">Giới thiệu</h3>
                      <div className="space-y-3 text-[17px] leading-8 text-slate-700">
                        {String(aboutContentValue || '')
                          .split('\n')
                          .map(item => item.trim())
                          .filter(Boolean)
                          .map((paragraph, index) => (
